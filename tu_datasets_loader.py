...
#     node_degrees = degree(g.edge_index[0], num_nodes=g.num_nodes)
#     # print(node_degrees)
#     iso_node_list = (node_degrees == torch.tensor([0])).sum()
#     # print(iso_node_list)
#     if iso_node_list > 0:
#         num_iso_graphs += 1
# print("Total graphs with isolated nodes:  ", num_iso_graphs)

# g = graph_obj.graphs[1111]
# print(g)
